...
| **CP4 · Chốt tiến độ** | 17:30 N1 | 12:00 N2 | Spec gần cuối + việc còn thiếu. **Hạn cứng: spec.md commit 23:59 N1, quality bar chốt từ thời điểm này** | [x] evidence chuẩn A/B có log [x] bảng impact + ứng viên đã loại [x] 4 lớp cụ thể [x] ≥4 nguyên tắc có vị trí áp dụng [x] quality bar bằng số |
| **CP5 · Xác minh + validation + dry run** | 09:00 N2 | 14:00 N2 | Feedback log ≥5 mẩu có tên + changelog + slide final + dry run xong | [x] log đủ ≥5 có tên [x] 1 thành viên ngẫu nhiên giải thích được phần có tên mình [x] dry run xong |
